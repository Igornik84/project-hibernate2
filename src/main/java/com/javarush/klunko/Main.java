package com.javarush.klunko;

import com.javarush.klunko.dao.*;
import com.javarush.klunko.domein.*;
...
public class Main {
    ...
    private void newFilmWasMade() {
        try (Session session = sessionFactory.getCurrentSession()) {
            ...
            film.setOrigiLanguage(language);
    ...
    private void customerRentInventory(Customer customer) {
        try (Session session = sessionFactory.getCurrentSession()) {
            ...
            Film film = filmDAO.getFirstAvailbleFilmForRent();
    ...
    private Customer createCustomer() {
        try (Session session = sessionFactory.getCurrentSession()) {
            ...
            address.setAddress("Mira str, 12");
            address.setPhone("050-123-111");
            address.setCity(city);
            address.setDistrict("Assssaaaa");
